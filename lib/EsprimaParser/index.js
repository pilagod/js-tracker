...
class EsprimaParser {
  ...
  MemberExpression(memberExpression) {
    const exp = this.getMemberExp(memberExpression)
  ...
  CallExpression(callExpression) {
    const exp = this.getCallExp(callExpression)
  ...
  getCallExp(callExpression) {
    switch (callExpression.callee.type) {
      case 'MemberExpression':
        return this.parseMemberCallee(callExpression)

      default:
        return this.parseOtherCallee(callExpression)
    }
  }

  parseMemberCallee(callExpression) {
    // @TODO: callee -> new Callee
    // @TODO: addArguments
    // @TODO: return {caller, callee, info}
  }

  parseOtherCallee(callExpression) {
    // @TODO: caller -> undefined
    // @TODO: return {caller, callee}
  }

  parseCallExp(exp) {
    // const checkFlag = this.createCheckFlag(exp)
    //
    // this.setCheckFlag(exp, checkFlag)
    //
    // const result = this.execute(exp)
    //
    // this.resetCheckFlag(checkFlag)
    //
    // return result
  }

  createCheckFlag(exp) {
    // @TODO: new structure CheckFlag
  }

  setCheckFlag(exp, checkFlag) {
    // @TODO: is checkFlag set and is caller undefined?
    // @TODO: if both not, call checker.dispatch
    // @TODO: if result is valid, set checkFlag
    // @TODO: else, should not set checkFlag
  }

  resetCheckFlag(checkFlag) {
    // @TODO: setCheckedFlag back
  }
