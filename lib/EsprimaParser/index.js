...
class EsprimaParser {
  constructor() {
    ...
    // set operator
    this.unaryOperator = Object.assign({}, unaryOperator, {
      delete: () => {
  ...
  UnaryExpression(unaryExpression) {
    ...
    return this.getUnaryExpressionResult(unaryExpression.argument, unaryOperation)
  }

  getUnaryExpressionResult(argument, unaryOperation) {
    /* @TODO: for delete: member expression should not get value */
    /* @TODO: for delete: object property (should get reference first), array element (directly delete) */
  }
}
