...
class EsprimaParser {
  ...
  executeExpression(data) {
    ...
    this.setStyleOrClassListParent(data, executedData)

    return executedData
  }

  setStyleOrClassListParent(data, executedData) {
    // @TODO: should pass rawData and executedData
    ...
    this.isStyleOrClassList(executedData)
  }

  isStyleOrClassList(executedData) {
