...
class EsprimaParser {
  ...
  parseNode() {
    // @TODO: should check argument type (null)
  }
  ...
  ForInStatement(forInStatement) {
    const left = this.getNameFromDeclarationAndPattern(
      forInStatement.left
    )
    ...
    for (const key in right) {
      this.closureStack.update(left, key)
  ...
  getNameFromDeclarationAndPattern(node) {
