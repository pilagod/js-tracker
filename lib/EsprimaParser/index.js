...
class EsprimaParser {
  ...
  BlockStatement(blockStatement) {
    ...
    for (const node of blockStatement.body) {
      ...
      // only ReturnStatement, ContinueStatement, BreakStatement have return value
      if (result) {
        break
      }
    }
  ...
  IfStatement(ifStatement) {
    ...
    // under if statement might contain flow control statement,
    // should return signal to caller
    if (testPass) {
