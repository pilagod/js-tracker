...
class EsprimaParser {
  ...
  BreakStatement() {
    this.flowState.set('break')
  }

  ContinueStatement() {
    this.flowState.set('continue')
  }
  ...
  checkAndExecuteReducer(info, resultStack, curExp) {
    ...
    const curExpStatus = this.getCurExpStatus(curResult, curExp)
  ...
  getCurExpStatus(curResult, curExp) {
    // @TODO: need to check pre result
    // @TODO: curExp go through all handlers
    // @TODO: handler return status containing state and data
  }
