...
class EsprimaParser {
  ...
  parseCallExpression(callExpression) {
    ...
    const {callee, calledMethod} = this.getCalleeAndCalledMethod(callExpression.callee, calledArguments)
    
    return callee ? [...callee, calledMethod] : [calledMethod]
  }
  ...
  getCalleeAndCalledMethod(callee, calledArguments) {
