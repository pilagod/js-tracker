...
class EsprimaParser {
  ...
  Program(program) {
    // @TODO: handleHoisting here
    this.parseStatements(program.body)
  }

  parseStatements(statements) {
    // @TODO: not handleHoisting here
  ...
  initFunctionHoisting(functionDeclaration) {
    const variable =
      this.getNameFromPattern(functionDeclaration.id)
  ...
  initVariableHoisting(variableDeclaration) {
